...
<body>
    ...
    <main>
        ...
        <section class="section-2" id="about">
            <div class="container-2 d-flex align-items-center">
                <div class="div-conect text-left" data-aos="fade-right">
                    ...
                    <p class="text-2 mt-2">
                        Palestrantes renomados irão entregar seu conhecimento, e segredos que os fizeram prosperar e fazer sucesso.
                    </p>
                    <p class="text-2 mt-2">
                        Com muita conexão e inovação para você se transformar e evoluir.
                    </p>
                    <p class="mt-3 text-2 text-bold">
                        Este evento contém:
                    </p>
        ...
        <section class="section-2" id="speakers">

            <div class="container-2">
                <p class="text-4">Palestrantes Confirmados</p>
            </div>
                ...
                <div class="div-cards-4">
                    ...
                    <div class="card-4">
                        ...
                        <div class="hover-description text-grey">
                            ...
                            <div class="div-social">
                                <a href="https://www.instagram.com/professora_jessicacapistrano/" class="text-grey" target="_blank" style="font-size: 1rem"><i class="fa-brands fa-instagram mr-1"></i>professora_jessicacapistrano</a>
                            </div>
                        </div>
                        <div class="border-name text-white">
                    ...
                    <div class="card-4">
                        <img src="assets/media/analice.png" alt="Analice Ramlow">
                        <div class="hover-description text-grey">
                            <div class="text-1">
                                <p class="">
                                    Analice Ramlow,
                            ...
                            <div class="div-social">
                                <a href="https://www.instagram.com/analiceramlow/" class="text-grey text-2" target="_blank"><i class="fa-brands fa-instagram mr-1"></i>analiceramlow</a>
                            </div>
                        </div>
                        <div class="border-name text-white">
        ...
        <section class="section-1" class="section-payment" id="payment">
            <div class="container-2">
                <p class="text-4 text-bold">GARANTA JÁ O SEU INGRESSO</p>
            </div>
        ...
        <section class="section-1" id="sponsors" style="padding: 0;background-image: url('assets/media/background-2.webp');">
            <div class="container-2 mt-4 mb-4">
                ...
                <div class="div-card-3 img-t1 mt-3">
                    ...
                    <a href=" https://www.instagram.com/judocesefestas/" target="_blank">
                        <div class="card-3">
                            <img src="assets/media/patrocinadores/p-5.png" alt="Patrocinador | Ju Doces e Festas" title="Ju Doces e Festas">
                        </div>
                    </a>
                    <a href="https://www.instagram.com/paesstipp/" target="_blank">
                        <div class="card-3">
                    ...
                    <a href="https://www.instagram.com/tocadosaborprodutosartesanais/" target="_blank">
                        <div class="card-3">
                            <img src="assets/media/patrocinadores/p-7.png" alt="Patrocinador | Toca do sabor" title="Toca do sabor">
                        </div>
                    </a>
                    <a href="https://www.instagram.com/4selfoficial/" target="_blank">
                        <div class="card-3">
            ...
            <div class="container-2 d-flex align-items-center">
                ...
                <div class="ml-2">
                    <div class="div-maps" style="border-radius: 8px;overflow:hidden;">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d883.942940869611!2d-48.612001970755195!3d-27.600604810441947!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9527373a7fd56e69%3A0x2ea1f8333ad18d4e!2sK-Platz%20Corporate!5e0!3m2!1spt-BR!2sbr!4v1656464256046!5m2!1spt-BR!2sbr" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    <div class="mt-2">
                        <a href="https://goo.gl/maps/fKY5F5FnYzoakDHq9" class="btn btn-primary mt-4">
                            <span class="text-3">Como chegar</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="section-1" id="info">
            ...
            <div class="container-2 mt-3">
                ...
                <button class="accordion mt-2">
                    <span class="text-2">Terá comida no local?</span>
                    <i class="fa-solid fa-angle-up"></i>
                </button>
                <div class="panel">
                ...
                <button class="accordion mt-2">
                    <span class="text-2">Como devo me vestir?</span>
                    <i class="fa-solid fa-angle-up"></i>
                </button>
                <div class="panel">
                    <p class="text-2">Não teremos nenhum padrão de vestimenta, então sinta-se a vontade para fazer o seu look.</p>
                </div>
            </div>
        ...
        <section class="section-2">
            <p class="text-4 text-bold">Ficou com alguma dúvida?</p>
            <p class="text-2 mt-3">Clique no botão abaixo e fale conosco.</p>
            <a href="https://wa.me/554896956673" target="_blank">
                <button class="btn btn-secondary mt-2">
                    <span class="text-2 text-bold">CLIQUE AQUI E FALE CONOSCO</span>
                </button>
            </a>
        </section>
    ...
    <a href="https://wa.me/554896956673" target="_blank">
        <div class="div-contact">
            <div class="div-contact-left">
                <span class="text-2"></span>
            </div>
            <div class="div-contatc-right">
                <i class="fa-brands fa-whatsapp text-5"></i>
            </div>
        </div>
    </a>
